...
dispatch begin
  ...
  | After_rules ->
    ...
    (* Linking cstubs *)
    dep ["c"; "compile"; "use_time_util"]
      ["unix/unix_time_util.o"; "unix/unix_time_util.h"];
    flag ["c"; "compile"; "use_ctypes"] & S[A"-I"; A ctypes_libdir];
    flag ["c"; "compile"; "debug"] & A"-g";

    (* Linking generated stubs *)
    dep ["ocaml"; "link"; "byte"; "library"; "use_time_stubs"]
      ["unix/dllunix_time_stubs"-.-(!Options.ext_dll)];
    flag ["ocaml"; "link"; "byte"; "library"; "use_time_stubs"] &
      S[A"-dllib"; A"-lunix_time_stubs"];

    dep ["ocaml"; "link"; "native"; "library"; "use_time_stubs"]
      ["unix/libunix_time_stubs"-.-(!Options.ext_lib)];
    flag ["ocaml"; "link"; "native"; "library"; "use_time_stubs"] &
      S[A"-cclib"; A"-lunix_time_stubs"];

    (* Linking tests *)
    flag ["ocaml"; "link"; "byte"; "program"; "use_time_stubs"] &
      S[A"-dllib"; A"-lunix_time_stubs"; A"-I"; A"unix/"];
    dep ["ocaml"; "link"; "native"; "program"; "use_time_stubs"]
      ["unix/libunix_time_stubs"-.-(!Options.ext_lib)];
